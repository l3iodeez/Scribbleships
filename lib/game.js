...
Asteroids.Game.prototype.advanceLevel = function () {
  ...
  this.gameview.messageText = "Entering level " + this.level;
  setTimeout(function () {
...
Asteroids.Game.prototype.draw = function (ctx, img) {
  ...
  this.mousePos.x; // some voodoo here. need to fix. deleting this breaks the game.

  this.allObjects().forEach(function (el) {
    var viewPos = this.gameview.translateGlobalToViewCoordinates(el.pos, this.ship.pos);
    el.draw(ctx, this.mousePos, viewPos);
  }.bind(this));
};
