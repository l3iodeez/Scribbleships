...
Asteroids.Game.prototype.decrementCountdowns = function (delta) {
  this.time -= delta/1000;
  this.planetTime -= delta/1000;
...
Asteroids.Game.prototype.spawnTimedMobs = function (delta) {
  if (this.planetTime < 0) {
    this.planetTime = Asteroids.rangeRandom(45, 90);
    this.spawnAsteroid(this.randomPosition(), Asteroids.randomVec(1), "planet", this);
  }
};
