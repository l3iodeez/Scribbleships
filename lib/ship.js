...
Asteroids.Ship.prototype.bulletVector = function () {
  var bulletDirection = Asteroids.directionVector(this.pos, [this.game.mousePos.x,this.game.mousePos.y]);
...
Asteroids.Ship.prototype.draw = function (ctx, mousePos) {
  ...
  var mouseAngle = Asteroids.vectorToAngle(Asteroids.directionVector(this.pos, [this.game.mousePos.x, this.game.mousePos.y])) - (3 * Math.PI /2) ;
